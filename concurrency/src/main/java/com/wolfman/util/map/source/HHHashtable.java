...
public class HHHashtable<K,V> extends Dictionary<K,V> implements Map<K,V> , Cloneable, java.io.Serializable {
     ...
     */
    public HHHashtable(int initialCapacity, float loadFactor) {
     ...
     * @param initialCapacity 容量大小
     */
    public HHHashtable(int initialCapacity) {
     ...
     * @since   1.2
     */
    public HHHashtable(Map<? extends K, ? extends V> t) {
    ...
    public synchronized Object clone() {
        try {
            HHHashtable<?,?> t = (HHHashtable<?,?>)super.clone();
    ...
    private class KeySet extends AbstractSet<K> {
        ...
        public boolean remove(Object o) {
            return HHHashtable.this.remove(o) != null;
        }
        public void clear() {
            HHHashtable.this.clear();
        }
    }
    ...
    private class Enumerator<T> implements Enumeration<T>, Iterator<T> {
        // 指向Hashtable的table
        Entry<?,?>[] table = HHHashtable.this.table;
        // Hashtable的总的大小
        ...
        public void remove() {
            ...
            synchronized(HHHashtable.this) {
                Entry<?,?>[] tab = HHHashtable.this.table;
